			...
			<div>
				...
				<fieldset id="ali_field" style="display: none;">
					...
					<table style="border-spacing: 10px">
						...
						<tr>
							<td>支付宝私钥：</td>
							<td><input type="text" name="ali_rsaPrivateKey" id="ali_rsaPrivateKey" maxlength="10000" class="required" /></td>
						</tr>
						<tr>
							<td>支付宝公钥：</td>
							<td><input type="text" name="ali_rsaPublicKey" id="ali_rsaPublicKey" maxlength="10000" class="required" /></td>
						</tr>
					</table>
				</fieldset>
